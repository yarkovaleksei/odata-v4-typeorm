...
| `book` | 5 книг, одна без автора и раздела | `LEFT JOIN`, узел всех видов связей |
| `review` | 5 рецензий, одна без автора | Третий уровень связи |
| `publisher` | 3 издательства | `varchar` с длиной, `decimal`, `date`; обязательная связь |
...
| `book_details` | 3 записи | Связь «один к одному», тип `time` |
